...
/datum/chemical_reaction/cat
	...
	required_reagents  = list(/datum/reagent/toxin/mindbreaker = 1, /datum/reagent/ammonia = 1, /datum/reagent/water = 1,  /datum/reagent/mutationtoxin = 1) // Maybe aphro+ if it becomes a shitty meme
	required_temp = 450
